...
@forelse ($orders as $order)           
    <figure>   
        ...
        <hr>
        <div class="situation">
            <h3 class="text-situation verde-escuro">Saiu para<br>entrega</h3>
        ...
        <div class="card__order__action ">
            ...
            <a class="btn-order-next-status bordo" href="{{route("order.exchange.exchange",$order->id)}}">Mudar status para: Processo de troca</a>
